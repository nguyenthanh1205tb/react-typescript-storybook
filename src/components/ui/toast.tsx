...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'tw-fixed tw-top-0 tw-left-[50%] tw-z-[100] tw-flex tw-max-h-screen tw-w-full tw-translate-x-[-50%] tw-flex-col-reverse tw-p-4 sm:tw-right-0 sm:tw-flex-col md:tw-max-w-[420px]',
      className,
    )}
    {...props}
  />
